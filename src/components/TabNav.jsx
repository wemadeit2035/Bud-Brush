import { canAccessView } from "../constants/accessControl";

export default function TabNav({ activeView, onChangeView, userRole }) {
  const tabs = [
    { id: "pos", label: "POS", iconSrc: "/pos.svg" },
    { id: "members", label: "Members", iconSrc: "/members.svg" },
        ...
        .map((tab) => (
          <a
            ...
            onClick={(event) => {
              ...
              if (canAccessView(userRole, tab.id)) {
                onChangeView(tab.id);
              }
            }}
          >
